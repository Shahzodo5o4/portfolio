...
const PROFILE = {
  ...
  summary:
    "Data analyst turning raw data into clear, actionable insights — from the SQL that finds the leak through to the Power BI report that prices it. Currently Manager of International Rankings at TUIT, Tashkent. Experienced in working with machine learning, NLP, and large language models, including production-style multi-agent systems with RAG, evaluation, and tracing. Google-certified across the full analytics workflow.",
  socials: {
